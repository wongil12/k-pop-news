...
const StyledCalendarIcon = styled(Flex.Horizontal)`
  position: relative;
  width: 42px;
  height: 42px;
`;
...
function CalendarIcon({ borderColor, emoji, image, disabled }: CalendarIconProps) {
  const color = disabled ? ASSETS.COLORS.Neutural300 : borderColor;

  return (
    <StyledCalendarIcon alignItems='center' justifyContent='center'>
